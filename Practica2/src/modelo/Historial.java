...
public class Historial {
    ...
    private int numero_batalla;
    private String fecha;
    private String pokemon1;
    private String pokemon2;
    private String ganador;

    public Historial(int numero_batalla, String fecha, String pokemon1, String pokemon2, String ganador) {
        this.numero_batalla = numero_batalla;
        this.fecha = fecha;
        this.pokemon1 = pokemon1 +  " " + "Vs" + " "+ pokemon2;
